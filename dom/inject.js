...
<p>I really look forward to learning how to code!  Have a great day.  
-[Team "Git'er Done"]</p>;`
let codePenToInject = (item) =>{
    document.getElementById("inject").insertAdjacentHTML("afterbegin", item);
}
codePenToInject(codePenHtml);
